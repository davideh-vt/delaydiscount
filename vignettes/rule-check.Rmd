...
After that, the remainder of the workflow proceeds as it would otherwise, starting from running the `prepare_data_frame` function on the dataset with rule check failures filtered out. 
